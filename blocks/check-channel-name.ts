...
function containsInvalidCharacter(input: string, characters: string): boolean {
...
function validateInput(channel_name: any, channel_type: string): boolean {
        ...
        case "text":
            return (
                !containsInvalidCharacter(
                    channel_name.trim(),
                    INVALID_TEXT_CHANNEL_CHARACTERS,
                ) &&
...
const block: Block = {
    ...
    description:
        "Check whether a channel name is valid for the given channel type",
    ...
    options: [
        {
            ...
            name: "Channel Type",
            description:
                "Description: the type of channel to verify the name for",
            type: "SELECT",
            options: {
                text: "Text Channel",
                voice: "Voice Channel",
