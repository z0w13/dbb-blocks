...
function processInput(input, objectProcessMethod) {
    ...
    if (typeof input === "object") {
        switch (objectProcessMethod) {
            ...
            default:
                throw new Error(`invalid object process method: ${objectProcessMethod}`);
        }
    }
...
const block = {
    ...
    inputs: [
        ...
        },
        {
            id: "in1",
            name: "Input 1",
            description: "Type: List, Array, Set, Object\n\nDescription: first value to compare",
            types: ["list", "object"],
        },
        {
            id: "in2",
    ...
    options: [
        {
            ...
            options: {
                ...
                symdiff: "Symmetric Diff (return values that are in either input but not both)",
            },
        },
        {
    ...
    code(cache) {
        ...
        const operated = executeSetOperation(processed1, processed2, options["operation"]);
